...
std::vector<Node> calculateSuccessors(Node n) {
	...
	case '.': {
        ...
        case 1:
            ...
            break;
        case 2: {
            assert(choice_index < choice_vector.size());
            
            auto choice = choice_vector[choice_index];
            
            ns.push_back(choices[choice]);
...
int main(int argc, char **argv) {
	...
	// const char *path = "/Users/brenton/development/github/AdventOfCode2023/day23/input.txt";
